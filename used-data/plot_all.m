...
%     plot(f,day_2_ch1,'linewidth',2),xlim([0.1 15]),ylim([0 2.5]),set(gca,'fontsize',18),set(gca,'xtick',0:2:20)...
%         ,legend('10月4号','10月5号','10月6号','10月7号','4天总叠加'),set(legend,'fontsize',8),title('2# NS')...
%         ,ylabel('幅值','fontsize',18),xlabel('频率 f/Hz','fontsize',18)
% subplot(2,3,2),plot(f,day4_2_ch2,f,day5_2_ch2,f,day6_2_ch2,f,day7_2_ch2,'linewidth',1.3),hold on
%     plot(f,day_2_ch2,'linewidth',2),xlim([0.1 15]),ylim([0 1.5]),set(gca,'fontsize',18),set(gca,'xtick',0:2:20)...
...
%     plot(f,day_2_ch3,'linewidth',2),xlim([0.1 15]),ylim([0 1]),set(gca,'fontsize',18),set(gca,'xtick',0:2:20)...
...
%     plot(f,day_3_ch1,'linewidth',2),xlim([0.1 15]),ylim([0 2]),set(gca,'fontsize',18),set(gca,'xtick',0:2:20)...
...
%     plot(f,day_3_ch2,'linewidth',2),xlim([0.1 15]),ylim([0 1.5]),set(gca,'fontsize',18),set(gca,'xtick',0:2:20)...
...
%     plot(f,day_3_ch3,'linewidth',2),xlim([0.1 15]),ylim([0 1]),set(gca,'fontsize',18),set(gca,'xtick',0:2:20)...
%         ,legend('10月4号','10月5号','10月6号','10月7号','4天总叠加'),set(legend,'fontsize',8),title('3# UD')...
%         ,ylabel('幅值','fontsize',18),xlabel('频率 f/Hz','fontsize',18)

figure(100)
subplot(2,3,1),plot(f,abs(alpha_day4_2_ch1),f,abs(alpha_day5_2_ch1),f,abs(alpha_day6_2_ch1),f,abs(alpha_day7_2_ch1),'linewidth',1.4),hold on
    plot(f,abs(alpha_2_ch1),'linewidth',2),xlim([0.1 24]),ylim([0 2.5]),set(gca,'fontsize',18),set(gca,'xtick',0:5:25)...
        ,legend('10月4号','10月5号','10月6号','10月7号','4天总叠加'),set(legend,'fontsize',8),title('2# NS')...
        ,ylabel('幅值','fontsize',18),xlabel('频率 f/Hz','fontsize',18),set(gca,'xtick',[0.1 5 10 15 20 25])
subplot(2,3,2),plot(f,abs(alpha_day4_2_ch2),f,abs(alpha_day5_2_ch2),f,abs(alpha_day6_2_ch2),f,abs(alpha_day7_2_ch2),'linewidth',1.4),hold on
    plot(f,abs(alpha_2_ch2),'linewidth',2),xlim([0.1 24]),ylim([0 1.5]),set(gca,'fontsize',18),set(gca,'xtick',0:5:25)...
        ,legend('10月4号','10月5号','10月6号','10月7号','4天总叠加'),set(legend,'fontsize',8),title('2# EW')...
        ,ylabel('幅值','fontsize',18),xlabel('频率 f/Hz','fontsize',18),set(gca,'xtick',[0.1 5 10 15 20 25])
subplot(2,3,3),plot(f,abs(alpha_day4_2_ch3),f,abs(alpha_day5_2_ch3),f,abs(alpha_day6_2_ch3),f,abs(alpha_day7_2_ch3),'linewidth',1.4),hold on
    plot(f,abs(alpha_2_ch3),'linewidth',2),xlim([0.1 24]),ylim([0 1]),set(gca,'fontsize',18),set(gca,'xtick',0:5:25)...
        ,legend('10月4号','10月5号','10月6号','10月7号','4天总叠加'),set(legend,'fontsize',8),title('2# UD')...
        ,ylabel('幅值','fontsize',18),xlabel('频率 f/Hz','fontsize',18),set(gca,'xtick',[0.1 5 10 15 20 25])
subplot(2,3,4),plot(f,abs(alpha_day4_3_ch1),f,abs(alpha_day5_3_ch1),f,abs(alpha_day6_3_ch1),f,abs(alpha_day7_3_ch1),'linewidth',1.4),hold on
    plot(f,abs(alpha_3_ch1),'linewidth',2),xlim([0.1 24]),ylim([0 2]),set(gca,'fontsize',18),set(gca,'xtick',0:5:25)...
        ,legend('10月4号','10月5号','10月6号','10月7号','4天总叠加'),set(legend,'fontsize',8),title('3# NS')...
        ,ylabel('幅值','fontsize',18),xlabel('频率 f/Hz','fontsize',18),set(gca,'xtick',[0.1 5 10 15 20 25])
subplot(2,3,5),plot(f,abs(alpha_day4_3_ch2),f,abs(alpha_day5_3_ch2),f,abs(alpha_day6_3_ch2),f,abs(alpha_day7_3_ch2),'linewidth',1.4),hold on
    plot(f,abs(alpha_3_ch2),'linewidth',2),xlim([0.1 24]),ylim([0 1.5]),set(gca,'fontsize',18),set(gca,'xtick',0:5:25)...
        ,legend('10月4号','10月5号','10月6号','10月7号','4天总叠加'),set(legend,'fontsize',8),title('3# EW')...
        ,ylabel('幅值','fontsize',18),xlabel('频率 f/Hz','fontsize',18),set(gca,'xtick',[0.1 5 10 15 20 25])
subplot(2,3,6),plot(f,abs(alpha_day4_3_ch3),f,abs(alpha_day5_3_ch3),f,abs(alpha_day6_3_ch3),f,abs(alpha_day7_3_ch3),'linewidth',1.4),hold on
    plot(f,abs(alpha_3_ch3),'linewidth',2),xlim([0.1 24]),ylim([0 1]),set(gca,'fontsize',18),set(gca,'xtick',0:5:25)...
        ,legend('10月4号','10月5号','10月6号','10月7号','4天总叠加'),set(legend,'fontsize',8),title('3# UD')...
        ,ylabel('幅值','fontsize',18),xlabel('频率 f/Hz','fontsize',18),set(gca,'xtick',[0.1 5 10 15 20 25])
...
% figure(101)
% subplot(2,3,1),plot(f,abs(alpha_day4_2_ch1),f,abs(alpha_day5_2_ch1),f,abs(alpha_day6_2_ch1),f,abs(alpha_day7_2_ch1),'linewidth',1.4),hold on
%     plot(f,abs(alpha_2_ch1),'linewidth',2),xlim([1 24]),ylim([0 2.5]),set(gca,'fontsize',18)...
%         ,legend('10月4号','10月5号','10月6号','10月7号','4天总叠加'),set(legend,'fontsize',8),title('2# NS')...
%         ,ylabel('幅值','fontsize',18),xlabel('频率 f/Hz','fontsize',18),set(gca,'XScale','log')
% subplot(2,3,2),plot(f,abs(alpha_day4_2_ch2),f,abs(alpha_day5_2_ch2),f,abs(alpha_day6_2_ch2),f,abs(alpha_day7_2_ch2),'linewidth',1.4),hold on
%     plot(f,abs(alpha_2_ch2),'linewidth',2),xlim([1 24]),ylim([0 1.5]),set(gca,'fontsize',18),...
%         ,legend('10月4号','10月5号','10月6号','10月7号','4天总叠加'),set(legend,'fontsize',8),title('2# EW')...
%         ,ylabel('幅值','fontsize',18),xlabel('频率 f/Hz','fontsize',18),set(gca,'XScale','log')
% subplot(2,3,3),plot(f,abs(alpha_day4_2_ch3),f,abs(alpha_day5_2_ch3),f,abs(alpha_day6_2_ch3),f,abs(alpha_day7_2_ch3),'linewidth',1.4),hold on
%     plot(f,abs(alpha_2_ch3),'linewidth',2),xlim([1 24]),ylim([0 1]),set(gca,'fontsize',18),...
%         ,legend('10月4号','10月5号','10月6号','10月7号','4天总叠加'),set(legend,'fontsize',8),title('2# UD')...
%         ,ylabel('幅值','fontsize',18),xlabel('频率 f/Hz','fontsize',18),set(gca,'XScale','log')
% subplot(2,3,4),plot(f,abs(alpha_day4_3_ch1),f,abs(alpha_day5_3_ch1),f,abs(alpha_day6_3_ch1),f,abs(alpha_day7_3_ch1),'linewidth',1.4),hold on
%     plot(f,abs(alpha_3_ch1),'linewidth',2),xlim([1 24]),ylim([0 2]),set(gca,'fontsize',18),...
%         ,legend('10月4号','10月5号','10月6号','10月7号','4天总叠加'),set(legend,'fontsize',8),title('3# NS')...
%         ,ylabel('幅值','fontsize',18),xlabel('频率 f/Hz','fontsize',18),set(gca,'XScale','log')
% subplot(2,3,5),plot(f,abs(alpha_day4_3_ch2),f,abs(alpha_day5_3_ch2),f,abs(alpha_day6_3_ch2),f,abs(alpha_day7_3_ch2),'linewidth',1.4),hold on
%     plot(f,abs(alpha_3_ch2),'linewidth',2),xlim([1 24]),ylim([0 1.5]),set(gca,'fontsize',18),...
%         ,legend('10月4号','10月5号','10月6号','10月7号','4天总叠加'),set(legend,'fontsize',8),title('3# EW')...
%         ,ylabel('幅值','fontsize',18),xlabel('频率 f/Hz','fontsize',18),set(gca,'XScale','log')
% subplot(2,3,6),plot(f,abs(alpha_day4_3_ch3),f,abs(alpha_day5_3_ch3),f,abs(alpha_day6_3_ch3),f,abs(alpha_day7_3_ch3),'linewidth',1.4),hold on
%     plot(f,abs(alpha_3_ch3),'linewidth',2),xlim([1 24]),ylim([0 1]),set(gca,'fontsize',18),...
%         ,legend('10月4号','10月5号','10月6号','10月7号','4天总叠加'),set(legend,'fontsize',8),title('3# UD')...
%         ,ylabel('幅值','fontsize',18),xlabel('频率 f/Hz','fontsize',18),set(gca,'XScale','log')
...
%         ,set(gca,'fontsize',18),set(gca,'xtick',0:2:20),xlabel('频率 f/Hz','fontsize',18),ylabel('幅值','fontsize',18)
% end
% for i = 1:3
%     subplot(2,3,i+3)
...
for i = 1:3
    subplot(2,3,i)
    plot(f,z{1,1,i},f,z{2,1,i},f,z{3,1,i},f,z{4,1,i},f,z{5,1,i},f,z{6,1,i},f,z{7,1,i},f,z{8,1,i},f,z{9,1,i},f,z{10,1,i},...
        f,z{11,1,i},f,z{12,1,i},f,z{13,1,i},f,z{14,1,i},f,z{15,1,i},'linewidth',1.3),xlim([0.1 24])...
        ,set(gca,'fontsize',18),set(gca,'xtick',[0.1 5 10 15 20 25]),xlabel('频率 f/Hz','fontsize',18),ylabel('幅值','fontsize',18)
end
for i = 1:3
    subplot(2,3,i+3)
    plot(f,z{1,2,i},f,z{2,2,i},f,z{3,2,i},f,z{4,2,i},f,z{5,2,i},f,z{6,2,i},f,z{7,2,i},f,z{8,2,i},f,z{9,2,i},f,z{10,2,i},...
        f,z{11,2,i},f,z{12,2,i},f,z{13,2,i},f,z{14,2,i},f,z{15,2,i},'linewidth',1.3),xlim([0.1 24])...
        ,set(gca,'fontsize',18),set(gca,'xtick',[0.1 5 10 15 20 25]),xlabel('频率 f/Hz','fontsize',18),ylabel('幅值','fontsize',18)
end
handle = get(gcf,'children');
axes(handle(6));title('2# NS');set(handle(6),'ytick',0:0.5:3);
...
% load('测试数据总图.mat');
% figure(10)
% subplot(2,2,1),plot(fA,abs(z_1_test),fA,abs(z_1_revise),'linewidth',1.4),xlabel('频率 f/Hz','fontsize',22),ylabel('幅值','fontsize',22)...
%     ,set(gca,'fontsize',22),legend('真实值','估计值'),xlim([0 100]),set(legend,'fontsize',15)
% subplot(2,2,2),plot(fA,abs(z_1_test),fA,z_1_smooth,'linewidth',1.4),xlabel('频率 f/Hz','fontsize',22),ylabel('幅值','fontsize',22)...
%     ,set(gca,'fontsize',22),legend('真实值','平滑后的估计值'),xlim([0 100]),xlim([0 100]),set(legend,'fontsize',15)
% subplot(2,2,3),plot(fA,abs(z_2_test),fA,abs(z_2_revise),'linewidth',1.4),xlabel('频率 f/Hz','fontsize',22),ylabel('幅值','fontsize',22)...
%     ,set(gca,'fontsize',22),legend('真实值','估计值'),xlim([0 100]),xlim([0 100]),set(legend,'fontsize',15)
% subplot(2,2,4),plot(fA,abs(z_2_test),fA,z_2_smooth,'linewidth',1.4),xlabel('频率 f/Hz','fontsize',22),ylabel('幅值','fontsize',22)...
%     ,set(gca,'fontsize',22),legend('真实值','平滑后的估计值'),xlim([0 100]),xlim([0 100]),set(legend,'fontsize',15)
...
for i = 1:3
    subplot(2,3,i)
    plot(f,z{1,1,i},f,z{2,1,i},f,z{3,1,i},f,z{4,1,i},f,z{5,1,i},f,z{6,1,i},f,z{7,1,i},f,z{8,1,i},f,z{9,1,i},f,z{10,1,i},...
        f,z{12,1,i},f,z{13,1,i},f,z{14,1,i},f,z{15,1,i},'linewidth',1.3),xlim([0.1 24])...
        ,set(gca,'fontsize',18),set(gca,'xtick',[0.1 5 10 15 20 25]),xlabel('频率 f/Hz','fontsize',18),ylabel('幅值','fontsize',18)
end
for i = 1:3
    subplot(2,3,i+3)
