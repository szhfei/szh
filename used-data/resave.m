...
%     end
%     fclose(fid);
    save(['D:\szh\test\used-data\200#\',filename(5:14),'.mat'],'under_ch1','under_ch2','under_ch3');
...
%         end
%         fclose(fid);
        save(['D:\szh\test\used-data\',strcat(folder,'\'),month,day,hour,Min,sec,'.mat'],'surf_ch1','surf_ch2','surf_ch3');
