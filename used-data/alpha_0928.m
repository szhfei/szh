...
folder='8#\';
% [name_0928,name_3]=list('D:\szh\test\used-data\200#\',['D:\szh\test\used-data\',folder]);
load('D:\szh\test\used-data\namelist\name_0928.mat','name_0928');
l1=length(name_0928);
% for i=1:l1
%     if(strcmp(name_0928{i},name_3{i})==0)
%         disp('name error');
%         return
%     end
% end
...
%     fclose(fid);
%     iii=1;
for i=(6*(5-5)+1):(6*(19-5))
% for i=(6*7+1+0):(6*19+0)
%     if(iii<=9)
%         if(strcmp(name_0928{i},file{1}{iii})==1)
%             iii=iii+1;
%             continue
%         end
%     end
    load(['D:\szh\test\used-data\200#\',name_0928{i}],'under_ch2');
    load(['D:\szh\test\used-data\',folder,name_0928{i}],'surf_ch2');
