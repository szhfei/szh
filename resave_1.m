function [ch1,ch2,ch3]=resave_1(filename,kk)%存t3w 只存对应mat的一段
l=length(filename);
...
if(strcmp(postfix,'mat')==1)%mat 转存
    ...
    if(strcmp('#',changed_filename(5))==1)
        ...
        surf_ch1=D_a((kk*l+1):(kk*l+l),1);
        surf_ch2=D_a((kk*l+1):(kk*l+l),2);
        surf_ch3=D_a((kk*l+1):(kk*l+l),3);
