function [under_ch1,under_ch2,under_ch3,surf_ch1,surf_ch2,surf_ch3]=change(fileName1,fileName2,X)
...
if(X==1)
    fid=fopen(['D:\szh\test\',strcat(folder,'\'),fileName1(5:14),'.txt'],'r');
    if(fid==-1)
        fid=fopen(['D:\szh\test\',strcat(folder,'\'),fileName1(5:14),'.txt'],'w+');
